...
export class QuoteComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.quoteService
            ...
            .subscribe(
                (res: HttpResponse<IQuote[]>) => this.paginateQuotes(res.body, res.headers),
    ...
    trackId(index: number, item: IQuote) {
        return item.id;
    }
    ...
    protected paginateQuotes(data: IQuote[], headers: HttpHeaders) {

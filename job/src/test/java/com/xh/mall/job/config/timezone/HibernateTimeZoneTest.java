package com.xh.mall.job.config.timezone;

import com.xh.mall.job.JobApp;
import com.xh.mall.job.config.SecurityBeanOverrideConfiguration;
import com.xh.mall.job.repository.timezone.DateTimeWrapper;
import com.xh.mall.job.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, JobApp.class})
